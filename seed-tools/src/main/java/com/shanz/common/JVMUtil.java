...
import com.shanz.thread.NamedPoolThreadFactory;
...
public class JVMUtil {
    ...
    public static void dumpJstack(final String jvmPath) {
        new NamedThreadFactory().newThread("dump-jstack-t", (() -> {
    ...
    private synchronized static void initHotSpotMBean() throws Exception {
    ...
    public static void dumpJmap(final String jvmPath) {
        new NamedThreadFactory().newThread("dump-jmap-t", () -> jMap(jvmPath, false)).start();
    }
}
